...
* [```9a88f562```](https://github.com/ktmeaton/plague-phylogeography/commit/9a88f562) Remove lsd2 from install workflow
* [```68d59861```](https://github.com/ktmeaton/plague-phylogeography/commit/68d59861) checkpoint denmark metadata
* [```cce4a39e```](https://github.com/ktmeaton/plague-phylogeography/commit/cce4a39e) Remove plotting SNPs from default targets to test CI
* [```409d678a```](https://github.com/ktmeaton/plague-phylogeography/commit/409d678a) new denmark and plague notebook changes
* [```342170b5```](https://github.com/ktmeaton/plague-phylogeography/commit/342170b5) new timeline for individuals
* [```ad3d996a```](https://github.com/ktmeaton/plague-phylogeography/commit/ad3d996a) more geographic stats
* [```e2f9e68b```](https://github.com/ktmeaton/plague-phylogeography/commit/e2f9e68b) new geo stats
* [```ef9006fd```](https://github.com/ktmeaton/plague-phylogeography/commit/ef9006fd) automated updated
* [```789bb0c5```](https://github.com/ktmeaton/plague-phylogeography/commit/789bb0c5) prettier beast estimates file
* [```04387e4c```](https://github.com/ktmeaton/plague-phylogeography/commit/04387e4c) time dependency and tree rates update
* [```13f81fdc```](https://github.com/ktmeaton/plague-phylogeography/commit/13f81fdc) new script newick to nextstrain
* [```07aa3807```](https://github.com/ktmeaton/plague-phylogeography/commit/07aa3807) automated update
* [```f532276a```](https://github.com/ktmeaton/plague-phylogeography/commit/f532276a) use old 2.MED tree
* [```6f764559```](https://github.com/ktmeaton/plague-phylogeography/commit/6f764559) update branch lengths notebooks
* [```77aaca79```](https://github.com/ktmeaton/plague-phylogeography/commit/77aaca79) update notebooks for mean rate
* [```e276513b```](https://github.com/ktmeaton/plague-phylogeography/commit/e276513b) new plotting for mean rate
* [```4553d334```](https://github.com/ktmeaton/plague-phylogeography/commit/4553d334) locus cov changes for main
* [```78a1bc7a```](https://github.com/ktmeaton/plague-phylogeography/commit/78a1bc7a) initialize bash shell for conda activate
* [```11e26976```](https://github.com/ktmeaton/plague-phylogeography/commit/11e26976) add lsd2 to dockerfile
* [```4c7f04ae```](https://github.com/ktmeaton/plague-phylogeography/commit/4c7f04ae) fix conda-activate command
* [```b4729f1d```](https://github.com/ktmeaton/plague-phylogeography/commit/b4729f1d) fix download ftp links
* [```6538c5c5```](https://github.com/ktmeaton/plague-phylogeography/commit/6538c5c5) fix lsd2 install dir
* [```60edd837```](https://github.com/ktmeaton/plague-phylogeography/commit/60edd837) test lsd2 install
* [```8e70f393```](https://github.com/ktmeaton/plague-phylogeography/commit/8e70f393) update readme overview and installation
* [```86dd395a```](https://github.com/ktmeaton/plague-phylogeography/commit/86dd395a) start edits to locus coverage viz
* [```734edaeb```](https://github.com/ktmeaton/plague-phylogeography/commit/734edaeb) update denmark timeline figure
* [```7337d9a8```](https://github.com/ktmeaton/plague-phylogeography/commit/7337d9a8) some plotting of outlier detection
* [```95860fec```](https://github.com/ktmeaton/plague-phylogeography/commit/95860fec) save multivariate kde before undoing
* [```f935e37b```](https://github.com/ktmeaton/plague-phylogeography/commit/f935e37b) update auspice
* [```d621549f```](https://github.com/ktmeaton/plague-phylogeography/commit/d621549f) adjust phylogeny targets
* [```5b468c6d```](https://github.com/ktmeaton/plague-phylogeography/commit/5b468c6d) simplify download assembly rule
* [```c5b1be58```](https://github.com/ktmeaton/plague-phylogeography/commit/c5b1be58) rebase
* [```8060043e```](https://github.com/ktmeaton/plague-phylogeography/commit/8060043e) add variant qc comment to db
* [```43a45548```](https://github.com/ktmeaton/plague-phylogeography/commit/43a45548) Merge branch 'master' of https://github.com/ktmeaton/plague-phylogeography into master
* [```3160faf9```](https://github.com/ktmeaton/plague-phylogeography/commit/3160faf9) add other stats to dnds
* [```2c3810f2```](https://github.com/ktmeaton/plague-phylogeography/commit/2c3810f2) add new targets to unload
* [```99998eea```](https://github.com/ktmeaton/plague-phylogeography/commit/99998eea) add progress bar to singletons
* [```c4b8ba58```](https://github.com/ktmeaton/plague-phylogeography/commit/c4b8ba58) separate rule for singletons
* [```35e6aabb```](https://github.com/ktmeaton/plague-phylogeography/commit/35e6aabb) separate rule for singletons
* [```e088690d```](https://github.com/ktmeaton/plague-phylogeography/commit/e088690d) more customization for migrate rename
* [```4b38c365```](https://github.com/ktmeaton/plague-phylogeography/commit/4b38c365) new targets for snippy pairwise
* [```a70574eb```](https://github.com/ktmeaton/plague-phylogeography/commit/a70574eb) make het standalone
* [```81a68a8a```](https://github.com/ktmeaton/plague-phylogeography/commit/81a68a8a) make master variant qc rule
* [```9b805395```](https://github.com/ktmeaton/plague-phylogeography/commit/9b805395) draft of tstv
* [```52802637```](https://github.com/ktmeaton/plague-phylogeography/commit/52802637) prepare for tstv
* [```306cb9cd```](https://github.com/ktmeaton/plague-phylogeography/commit/306cb9cd) add tstv script
* [```de29b5ba```](https://github.com/ktmeaton/plague-phylogeography/commit/de29b5ba) update dnds to filter on locus
* [```f2819f96```](https://github.com/ktmeaton/plague-phylogeography/commit/f2819f96) transfer scripts to edit
* [```f0cba682```](https://github.com/ktmeaton/plague-phylogeography/commit/f0cba682) add dnds statistics
* [```9649e755```](https://github.com/ktmeaton/plague-phylogeography/commit/9649e755) update meanrate stdev
* [```133d84ea```](https://github.com/ktmeaton/plague-phylogeography/commit/133d84ea) adjust iqtree stats to have time-dependency plot
* [```e560faee```](https://github.com/ktmeaton/plague-phylogeography/commit/e560faee) create migrate rename script
* [```a4a42474```](https://github.com/ktmeaton/plague-phylogeography/commit/a4a42474) update auspice notebook
* [```eb165bd0```](https://github.com/ktmeaton/plague-phylogeography/commit/eb165bd0) update auspice and locus coverage for pla
* [```3df9e8d9```](https://github.com/ktmeaton/plague-phylogeography/commit/3df9e8d9) update notebooks
* [```a0d86b8b```](https://github.com/ktmeaton/plague-phylogeography/commit/a0d86b8b) update scripts and notebook
* [```0d3807d3```](https://github.com/ktmeaton/plague-phylogeography/commit/0d3807d3) update notebooks and scripts
* [```4a0a4bde```](https://github.com/ktmeaton/plague-phylogeography/commit/4a0a4bde) update gokhem db
* [```11157246```](https://github.com/ktmeaton/plague-phylogeography/commit/11157246) curate metadata for madagascar and USA
* [```0fa93b55```](https://github.com/ktmeaton/plague-phylogeography/commit/0fa93b55) update db to 2021
* [```b4552207```](https://github.com/ktmeaton/plague-phylogeography/commit/b4552207) add xu2019 data to scripts
* [```2fe817e6```](https://github.com/ktmeaton/plague-phylogeography/commit/2fe817e6) update iqtree stats population terminology
* [```88591855```](https://github.com/ktmeaton/plague-phylogeography/commit/88591855) update USA metadata
* [```87e165c3```](https://github.com/ktmeaton/plague-phylogeography/commit/87e165c3) tidy up host metadata
* [```1ed06ecb```](https://github.com/ktmeaton/plague-phylogeography/commit/1ed06ecb) add host order to db
* [```4c54a3ae```](https://github.com/ktmeaton/plague-phylogeography/commit/4c54a3ae) fix geocoding info for two samples
* [```d0244eec```](https://github.com/ktmeaton/plague-phylogeography/commit/d0244eec) update beast plotting tmrca
* [```d9c03713```](https://github.com/ktmeaton/plague-phylogeography/commit/d9c03713) finish notes for 2021-08-04
* [```fd677971```](https://github.com/ktmeaton/plague-phylogeography/commit/fd677971) add first pandemic to multi plot
* [```85966225```](https://github.com/ktmeaton/plague-phylogeography/commit/85966225) new host proportion script
* [```a0a1bcda```](https://github.com/ktmeaton/plague-phylogeography/commit/a0a1bcda) update locus coverage
* [```3c1838f2```](https://github.com/ktmeaton/plague-phylogeography/commit/3c1838f2) add facecolor to plots
* [```120baa48```](https://github.com/ktmeaton/plague-phylogeography/commit/120baa48) checkpoint new locus coverage
* [```337df285```](https://github.com/ktmeaton/plague-phylogeography/commit/337df285) update jupyter notebooks
* [```59269f9b```](https://github.com/ktmeaton/plague-phylogeography/commit/59269f9b) plot sites for denmark notebook
* [```5e44c0c0```](https://github.com/ktmeaton/plague-phylogeography/commit/5e44c0c0) reset geo coloring
* [```0cf0407a```](https://github.com/ktmeaton/plague-phylogeography/commit/0cf0407a) new notebook to convert beast to auspice
* [```f239e677```](https://github.com/ktmeaton/plague-phylogeography/commit/f239e677) remove starting trees from beast
* [```0db7c76a```](https://github.com/ktmeaton/plague-phylogeography/commit/0db7c76a) restrict ES and marseille dates
* [```3bae1744```](https://github.com/ktmeaton/plague-phylogeography/commit/3bae1744) widen denmark db date
* [```91d1d9e9```](https://github.com/ktmeaton/plague-phylogeography/commit/91d1d9e9) update iqtree stats with error catching
* [```a0a43ed5```](https://github.com/ktmeaton/plague-phylogeography/commit/a0a43ed5) add perc axis
* [```8f304feb```](https://github.com/ktmeaton/plague-phylogeography/commit/8f304feb) update missing data thresholds for denmark
* [```15edcc28```](https://github.com/ktmeaton/plague-phylogeography/commit/15edcc28) add plots for rtt dist
* [```75982201```](https://github.com/ktmeaton/plague-phylogeography/commit/75982201) update homo het script
* [```6385c6c1```](https://github.com/ktmeaton/plague-phylogeography/commit/6385c6c1) restrict multiqc to qualimap and snippy modules
* [```7a61e82a```](https://github.com/ktmeaton/plague-phylogeography/commit/7a61e82a) fix date spacing
* [```84550df3```](https://github.com/ktmeaton/plague-phylogeography/commit/84550df3) update host metadata for denmark
* [```e74d7b0d```](https://github.com/ktmeaton/plague-phylogeography/commit/e74d7b0d) update branch support metadata
...
* [```25acf3d7```](https://github.com/ktmeaton/plague-phylogeography/commit/25acf3d7) update CHANGELOG for v0.2.8
...
* [```65e5dd89```](https://github.com/ktmeaton/plague-phylogeography/commit/65e5dd89) add host as visualization variable
* [```d6803fbd```](https://github.com/ktmeaton/plague-phylogeography/commit/d6803fbd) add plotting map
* [```4e0f6de1```](https://github.com/ktmeaton/plague-phylogeography/commit/4e0f6de1) add boxplots for rate and tmrca
* [```6b039800```](https://github.com/ktmeaton/plague-phylogeography/commit/6b039800) fix 0.PE subclades and add blank label
* [```51a98838```](https://github.com/ktmeaton/plague-phylogeography/commit/51a98838) start experimenting with p-values
* [```f199b8bb```](https://github.com/ktmeaton/plague-phylogeography/commit/f199b8bb) update auspice metadata
* [```8ded9416```](https://github.com/ktmeaton/plague-phylogeography/commit/8ded9416) remove mugration from all targets
* [```821de4d4```](https://github.com/ktmeaton/plague-phylogeography/commit/821de4d4) add temporal constraint plotting and input to tsv
* [```4f8eb7b6```](https://github.com/ktmeaton/plague-phylogeography/commit/4f8eb7b6) reset test outgroup to reference
* [```c20f5580```](https://github.com/ktmeaton/plague-phylogeography/commit/c20f5580) start writing bootstrap function
* [```7ed6eb6f```](https://github.com/ktmeaton/plague-phylogeography/commit/7ed6eb6f) test linear regression in stats
* [```70f780ba```](https://github.com/ktmeaton/plague-phylogeography/commit/70f780ba) remove old jupyter notebooks
* [```a1034200```](https://github.com/ktmeaton/plague-phylogeography/commit/a1034200) add auspice to snakemake
* [```9dc376ad```](https://github.com/ktmeaton/plague-phylogeography/commit/9dc376ad) add prune target for mugration
* [```ca46113f```](https://github.com/ktmeaton/plague-phylogeography/commit/ca46113f) create auspice by subtree
* [```fcfa1dd9```](https://github.com/ktmeaton/plague-phylogeography/commit/fcfa1dd9) fix reference date in metadata
* [```f31cc51a```](https://github.com/ktmeaton/plague-phylogeography/commit/f31cc51a) troubleshoot for test dataset
* [```56538eb1```](https://github.com/ktmeaton/plague-phylogeography/commit/56538eb1) add mugration to snakemake
* [```c1a3eace```](https://github.com/ktmeaton/plague-phylogeography/commit/c1a3eace) add pr title to changelog
