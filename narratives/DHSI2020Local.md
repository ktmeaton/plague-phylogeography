...
<br>
   3. [Publish In Place](http://localhost:4000/narratives/DHSI2020Local?n=7)
</pre>
</p>
...
<!----------------------------------------------------------------------------->
# [Exhibit](http://localhost:4000/cui2013Local?m=num_date&s=GCA_000013825.1_ASM1382v1_genomic)
...
<!----------------------------------------------------------------------------->
# [Exhibit](http://localhost:4000/cui2013Local?m=num_date)
...
<!----------------------------------------------------------------------------->
# [Interdisciplinary Perspectives](http://localhost:4000/cui2013Local?d=map&m=num_date&p=full&animate=1300-01-01,2006-01-01,1,0,30000)
...
<!----------------------------------------------------------------------------->
# [Interdisciplinary Perspectives](http://localhost:4000/cui2013Local?c=BioSampleHost&legend=closed&f_BioSampleHost=Marmota%20baibacina,Marmota%20caudata,Marmota%20himalayana,Marmota%20sibirica&m=num_date)
...
#### Link to this [digital narrative](http://localhost:4000/narratives/DHSI2020Local).
...
#### Link to the [2013 study interactive data](http://localhost:4000/cui2013Local?m=num_date).

http://localhost:4000/cui2013Local?m=num_date
...
#### 3. Fusing multiple stages of the research process in one software, which can be easily shared, provides alternatives for a number of collaborative hurdles. The ability to [Publish in Place](http://localhost:4000/narratives/DHSI2020Local?n=7) without switching formats makes it more likely to get ideas out.
